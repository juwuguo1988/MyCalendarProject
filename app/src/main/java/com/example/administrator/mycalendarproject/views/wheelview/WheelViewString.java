...
package com.example.administrator.mycalendarproject.views.wheelview;
...
//长字符串显示不下显示....缺点，不提供label 如1985年的汉字
public class WheelViewString extends View {

	/** Top and bottom shadows colors */

	// private int[] SHADOWS_COLORS = new int[] { 0xefE9E9E9, 0xcfE9E9E9, 0x3fE9E9E9 };
	//private int[] SHADOWS_COLORS = new int[] { 0xc8d16d, 0xc8d16d, 0xc8d16d };
	 ...
	 * Constructor
	 */
	public WheelViewString(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelViewString(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheelViewString(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 *            the view adapter
	 */
	public void setViewAdapter(WheelAdapter viewAdapter) {
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		itemsLayout.measure(
                MeasureSpec.makeMeasureSpec(width - 2 * PADDING, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
	...
	/*	Rect rect = new Rect(left, top, right, bottom)
		centerDrawable.setBounds(bounds) centerDrawable.setBounds(0, center - offset, getWidth(), center + offset);
		centerDrawable.draw(canvas);*/ //

		Paint paint = new Paint();
		paint.setColor(getResources().getColor(R.color.tab_cut_line));
		// 设置线宽
